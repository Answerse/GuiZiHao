...
const selectedSize = ref('100g')
const quantity = ref(1)

const productImages = [
  '/chenpitong/assets/images/product-main-01.png',
  '/chenpitong/assets/images/product-thumb-02.png',
  '/chenpitong/assets/images/product-thumb-03.png',
  '/chenpitong/assets/images/product-thumb-04.png'
]
        ...
        <div class="product-detail__inner">
          <div class="product-detail__images">
            <div class="product-detail__main-image">
              <img :src="productImages[activeThumbIndex]" alt="10-Year Vintage Chenpi" class="product-detail__main-img">
            </div>
          ...
          <div class="product-detail__info">
            <div class="product-detail__title-area">
              <h1 class="product-detail__name">
                <span class="product-detail__name--large">{{ t('pd-name-lg') }}</span>
                <span class="product-detail__name--spacer"> </span>
                <span class="product-detail__name--small">{{ t('pd-name-sm') }}</span>
              </h1>
            ...
            <div class="product-detail__benefits">
              <span>{{ t('pd-benefit1') }}</span>
              <span class="product-detail__benefit-dot"></span>
              <span>{{ t('pd-benefit2') }}</span>
            </div>

            <p class="product-detail__description">{{ t('pd-description') }}</p>

            <div class="product-detail__size-section">
              <p class="product-detail__size-label">{{ t('pd-size-label') }}</p>
              <div class="product-detail__size-options">
                <button 
                  class="product-detail__size-btn" 
                  :class="{ 'product-detail__size-btn--active': selectedSize === '100g' }"
                  @click="selectSize('100g')"
                >100g</button>
                <button 
                  class="product-detail__size-btn" 
                  :class="{ 'product-detail__size-btn--active': selectedSize === '250g' }"
                  @click="selectSize('250g')"
                >250g</button>
              </div>
            </div>
            ...
            <div class="product-detail__price-row">
              <div class="product-detail__price">
                <div class="product-detail__prices">
                  <span class="product-detail__price-value">$2,000.00</span>
            ...
            <button class="product-detail__buy-btn">{{ t('btn-buy') }}</button>
          </div>
        </div>
      </section>
        ...
        <div class="tasting-notes__inner">
            ...
            <div class="tasting-notes__list">
              <div class="tasting-notes__item">
                <div class="tasting-notes__item-img">
                  <img src="/chenpitong/assets/images/tasting-appearance-56586a.png" alt="Appearance">
                </div>
              ...
              <div class="tasting-notes__item">
                <div class="tasting-notes__item-img">
                  <img src="/chenpitong/assets/images/tasting-aroma-56586a.png" alt="Aroma">
                </div>
              ...
              <div class="tasting-notes__item">
                <div class="tasting-notes__item-img">
                  <img src="/chenpitong/assets/images/tasting-taste-56586a.png" alt="Taste">
                </div>
          ...
          <div class="tasting-notes__right">
            <div class="tasting-notes__illustration">
              <img class="tasting-notes__illustration-bg" src="/chenpitong/assets/images/tasting-illustration-bg-56586a.png" alt="Tasting Illustration Background">
              <img class="tasting-notes__illustration-fg" src="/chenpitong/assets/images/tasting-illustration-fg-15b631.png" alt="Tasting Illustration">
            </div>
          </div>
        </div>
      </section>
        ...
        <div class="pubei-story__inner">
          <div class="pubei-story__text">
            ...
            <div class="pubei-story__map">
              <img src="/chenpitong/assets/images/pubei-map-bg.png" alt="Pubei Map" class="pubei-story__map-img">
            </div>
            ...
            <div class="pubei-story__info">
              <div class="pubei-story__info-row">
                <div class="pubei-story__info-dot">
                  ...
                  <span class="pubei-story__info-bullet">&#8226;</span>
                </div>
          ...
          <div class="pubei-story__img">
            <img src="/chenpitong/assets/images/pubei-product-img.png" alt="Pubei Chenpi Closeup" class="pubei-story__img-photo">
          </div>
        </div>
      </section>
